      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <div className="space-y-2 text-gray-300 mb-6 text-sm md:text-base break-words">
              <p>📧 malikalevents@gmail.com</p>
              <p>📞 +91 90303 48600</p>
              <p>📍 Hyderabad, India</p>
            </div>
        ...
        <div className="border-t border-gray-600 pt-8 text-center text-gray-300 text-sm">
          <p>&copy; {new Date().getFullYear()} Malikal Events & Entertainment. All rights reserved.</p>
        </div>
      </div>
      
      {/* WhatsApp Floating Button */}
      <a
        href="https://wa.me/919030348600"
        target="_blank"
        rel="noopener noreferrer"
